...
subtest 'old reports' => sub { # Some reports are old
	$Mock::Reports_names_hashref = {
		'Foo-Bar-1.23.txt' => 'Foo-Bar-1.23.tar.gz',
		'Bar-4.673.txt'    => 'Bar-4.673.tar.gz',
		'Baz-8.673.txt'    => 'Baz-8.673.tar.gz',
...
subtest "newer reports" => sub { # Some reports are newer without matching dists
	$Mock::Reports_names_hashref = {
...
subtest 'no matching dists'	=> sub { # Some reports don't have matching dists
	$Mock::Reports_names_hashref = {
		'Baz-8.673.txt'    => 'Baz-8.673.tar.gz',
		};
	$Mock::Reports_arrayref      = [qw(
