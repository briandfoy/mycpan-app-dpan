...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/MyCPAN-App-DPAN> or
L<MetaCPAN|http://www.metacpan.org/module/MyCPAN::App::DPAN>:

=over 4

=item *	L<http://search.cpan.org/dist/MyCPAN-App-DPAN>

=item *	L<http://www.metacpan.org/module/MyCPAN::App::DPAN>
